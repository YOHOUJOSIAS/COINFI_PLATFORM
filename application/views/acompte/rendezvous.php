...
<div class="col-lg-9 wow">
     ...
     <div class="row g-5">
        ...
        <div class="team-item">
            ...
            <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                <h4 class="mb-2"><?php echo (int)$getRDVsEffectues->nombre; ?></h4>
                <p class="text-primary mb-0">RDVs EFFECTUÉS</p>
            </div>
        </div>
        </div>
        <div class="col-lg-4">
        ...
        <div class="team-item">
            ...
            <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                <h4 class="mb-2"><?php echo (int)$getRDVsAnnules->nombre; ?></h4>
                <p class="text-primary mb-0">RDVs ANNULÉS</p>
            </div>
        </div>
        </div>
	...
	<div class="news_posts">
		...
		<div class="news_post" style="margin-top: 30px; margin-bottom: 30px;">
		    ...
		    <tbody>
		    <?php foreach ($getMesRendezVous as $MesRendezVous) : ?>
		        <tr>
		        <td><?php echo $MesRendezVous->code_res; ?></td>
                <td><?php echo $MesRendezVous->nom_patients; ?>&nbsp;&nbsp;<?php echo $MesRendezVous->prenoms_patients; ?></td>
		        <td><?php echo $MesRendezVous->nom_entreprise; ?></td>
		        <td><?php echo date("d-m-Y H:i:s", strtotime($MesRendezVous->date_res_deb)); ?></td>
		        <td><?php echo $MesRendezVous->montant_res; ?></td>
		        <td><?php echo $MesRendezVous->qteProduits; ?></td>
                
                <?php if ($MesRendezVous->status_res == 'A') { ?>
                <td style="color:red;">Annulé</td>
                <?php }else if ($MesRendezVous->status_res == 'P') {?>
                <td style="color:black;">En Cours</td>
                <?php }else{?>
                <td style="color:green;">Effectué</td>
                <?php } ; ?>

                <?php if ($MesRendezVous->status_res != 'P') { ?>
		        <td><a href="<?php echo site_url("Reservations/voirListesVaccins")."/".$MesRendezVous->code_res ; ?>"  title="Voir Les Vaccins"><i class="fa fa-eye"></i></a></td>
                <?php }else{?>
                    <td><a href="<?php echo site_url("Reservations/voirListesVaccins")."/".$MesRendezVous->code_res ; ?>"  title="Voir Les Vaccins"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;<a href="<?php echo site_url("Reservations/desactiver")."/".$MesRendezVous->code_res ; ?>" onClick="return confirm('Voulez Vous Faire Cette Annulation ?')" title="Annuler le RDV"><i class="fa fa-times"></i></a></td>
                <?php } ; ?>
