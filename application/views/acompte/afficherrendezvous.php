				...
				<div class="col-lg-9 wow">
					...
					<div class="news_posts">
						...
						<div class="news_post" style="margin-bottom: 30px;">
						    ...
						    <h5 style="text-align:center;">RDV N°&nbsp;<?php echo $getCodeRes->code_res; ?>&nbsp;de&nbsp;<?php echo $getCodeRes->nom_patients; ?>&nbsp;<?php echo $getCodeRes->prenoms_patients; ?></h5>
					...
					<div align="center">
					<legend style="text-align:center;color: red;"><b>Liste des vaccins du RDV</b></legend>
